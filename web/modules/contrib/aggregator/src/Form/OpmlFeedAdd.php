...
class OpmlFeedAdd extends FormBase {
   ...
   */
  public function __construct(FeedStorageInterface $feed_storage, ClientInterface $http_client, protected DateFormatterInterface $dateFormatter) {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $validators = ['FileExtension' => ['opml xml']];
