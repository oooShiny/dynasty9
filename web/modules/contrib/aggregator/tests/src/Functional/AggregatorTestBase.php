...
abstract class AggregatorTestBase extends BrowserTestBase {
   ...
   *   Full feed object if possible or NULL if the feed could not be loaded.
   *
  ...
  public function updateFeedItems(FeedInterface $feed, $expected_count = NULL) {
    ...
    if ($expected_count !== NULL) {
      ...
      $this->assertEquals($expected_count, $item_count, \sprintf('Total items in feed equal to the total items in database (%d != %d)',
        $expected_count,
        $feed->item_count,
      ));
    }
