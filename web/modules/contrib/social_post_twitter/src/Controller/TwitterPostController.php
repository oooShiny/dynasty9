...
class TwitterPostController extends ControllerBase {
  ...
  public function callback() {
    ...
    try {
      ...
      if (!$this->userManager->getDrupalUserId($profile->id)) {
        $this->userManager->addUserRecord($profile->name, $this->currentUser()->id(), $profile->id, $profile->url, json_encode($access_token));
